            ...
            <div className="space-y-6">
                        ...
                        {isEnrolled ? (
                            <div className="flex items-center space-x-2">
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition shadow-xs"
                                    title="Download & Print Official Student ID Card"
                                >
                                    <CreditCard className="h-3.5 w-3.5 text-govt-green dark:text-emerald-400" />
                            ...
                            <div className="flex items-center space-x-2">
                                {hasApplied && (
                                    <Link
                                        href={route('student.id-card')}
                                        className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-xl text-xs font-bold bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 transition shadow-xs"
                                        title="View Student Identity Card"
                                    >
                                        <CreditCard className="h-3.5 w-3.5 text-govt-green dark:text-emerald-400" />
                ...
                {isEnrolled && (
                    <div className="space-y-6">
                        ...
                        ──────────────────────────────────────────────────────── */}
                        {/* ────────────────────────────────────────────────────────
                            TOPMOST: TODAY'S ATTENDANCE STATUS WIDGET
                        ──────────────────────────────────────────────────────── */}
                        {todayAttendance?.status === 'present' ? (
                            <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-emerald-600 via-emerald-700 to-emerald-800 text-white shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div className="flex items-start sm:items-center space-x-3.5">
                                    <div className="h-12 w-12 rounded-xl bg-white/20 text-white flex items-center justify-center font-bold shrink-0 shadow-xs">
                                        <CheckCircle2 className="h-7 w-7" />
                                    </div>
                                    <div>
                                        <div className="flex items-center space-x-2">
                                            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-white text-emerald-900 shadow-2xs">
                                                Marked Present
                                            </span>
                                        ...
                                        <p className="text-xs text-emerald-100/90 mt-0.5">
                                            Official class attendance recorded by your instructor {todayAttendance.marked_at ? `at ${todayAttendance.marked_at}` : ''}.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-2 shrink-0">
                                    <Link
                                        ...
                                        className="px-3.5 py-2 rounded-xl bg-white/15 hover:bg-white/25 text-white text-xs font-bold transition"
                                    >
                                        Request Future Leave
                                    </Link>
                                </div>
                            </div>
                        ) : todayAttendance?.status === 'absent' ? (
                            <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-rose-600 via-rose-700 to-rose-800 text-white shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div className="flex items-start sm:items-center space-x-3.5">
                                    <div className="h-12 w-12 rounded-xl bg-white/20 text-white flex items-center justify-center font-bold shrink-0 shadow-xs">
                                    ...
                                    <div>
                                        <div className="flex items-center space-x-2">
                                            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-white text-rose-900 shadow-2xs">
                                                Marked Absent
                                            </span>
                                        ...
                                        <p className="text-xs text-rose-100/90 mt-0.5">
                                            If you had a valid emergency or sickness, please submit an official leave request to your instructor.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-2 shrink-0">
                                    <Link
                                        href={route('student.leaves.index')}
                                        className="px-4 py-2 rounded-xl bg-white text-rose-900 text-xs font-bold transition hover:bg-rose-50 shadow-xs"
                                    >
                            ...
                            <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700 text-white shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div className="flex items-start sm:items-center space-x-3.5">
                                    <div className="h-12 w-12 rounded-xl bg-white/20 text-white flex items-center justify-center font-bold shrink-0 shadow-xs">
                                    ...
                                    <div>
                                        <div className="flex items-center space-x-2">
                                            <span className="px-2.5 py-0.5 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-white text-blue-900 shadow-2xs">
                                                Approved Leave
                                            </span>
                                        ...
                                        <p className="text-xs text-blue-100/90 mt-0.5">
                                            {todayAttendance.leave_reason ? `Reason: ${todayAttendance.leave_reason}` : 'Official student leave recorded and approved by faculty.'}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="p-5 sm:p-6 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div className="flex items-start sm:items-center space-x-3.5">
                                    <div className="h-12 w-12 rounded-xl bg-slate-100 text-slate-500 flex items-center justify-center font-bold shrink-0">
                                    ...
                                    <div>
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <span className="text-xs text-slate-400 font-medium">
                                                {todayAttendance?.date || new Date().toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' })}
                                            </span>
                                        </div>
                                        ...
                                        <p className="text-xs text-slate-500 mt-0.5">
                                            Your instructor will mark today's class roll call manually. Your status will appear here as soon as submitted.
                                        </p>
                                    </div>
                                </div>
                        ...
                        {/* ────────────────────────────────────────────────────────
                            MONTHLY DAY-BY-DAY ATTENDANCE RECORD
                        ──────────────────────────────────────────────────────── */}
                        {monthlyAttendance && (
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100">
                                    <div>
                                        <h3 className="font-bold text-slate-900 text-sm flex items-center space-x-2">
                                            ...
                                            <span>Monthly Attendance Record ({monthlyAttendance.month_name} {monthlyAttendance.year})</span>
                                        </h3>
                                        <p className="text-xs text-slate-500 mt-0.5">
                                            Day-by-day record of your presence in {latestEnrollment?.batch?.name || 'your batch'}
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex flex-wrap items-center gap-2 text-xs">
                                        <span className="px-2.5 py-1 rounded-lg bg-emerald-50 text-emerald-800 border border-emerald-200 font-bold">
                                            {monthlyAttendance.present_count} Present
                                        </span>
                                        <span className="px-2.5 py-1 rounded-lg bg-rose-50 text-rose-800 border border-rose-200 font-bold">
                                            {monthlyAttendance.absent_count} Absent
                                        </span>
                                        <span className="px-2.5 py-1 rounded-lg bg-blue-50 text-blue-800 border border-blue-200 font-bold">
                                            {monthlyAttendance.leave_count} Leave
                                        </span>
                                        <span className="px-2.5 py-1 rounded-lg bg-slate-100 text-slate-800 font-black">
                                            {monthlyAttendance.percentage}% Attendance
                                        </span>
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-center gap-1.5 min-w-max">
                                        {monthlyAttendance.days.map((d) => {
                                            ...
                                            return (
                                                <div
                                                    key={d.day}
                                                    className={`flex flex-col items-center justify-center p-1.5 rounded-xl min-w-[38px] border text-center transition ${
                                                        status === 'present'
                                                    ...
                                                    title={`${d.date} (${d.day_of_week}): ${status ? status.toUpperCase() : 'No Class / Off'}`}
                                                >
                                                    <span className="text-[9px] font-semibold uppercase">{d.day_of_week[0]}</span>
                                                    <span className="text-xs font-black">{d.day}</span>
                                                    <span className={`text-[10px] font-black mt-0.5 h-4 w-4 rounded-full flex items-center justify-center ${
                                                        status === 'present'
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="rounded-xl bg-gradient-to-br from-govt-green via-govt-green-600 to-[#00240E] p-5 sm:p-6 text-white shadow-card border border-govt-green-700/60 relative overflow-hidden flex flex-col justify-between space-y-5">
                                    ...
                                    <div className="mt-4 flex items-start space-x-3.5">
                                        {profile?.profile_picture_url ? (
                                            <img
                                                ...
                                                alt={user.name}
                                                className="h-16 w-16 rounded-xl object-cover border-2 border-white/40 shadow-sm bg-white shrink-0"
                                            />
                                        ) : (
                                            <div className="h-16 w-16 rounded-xl bg-white/15 border-2 border-dashed border-white/40 flex flex-col items-center justify-center text-white shrink-0 shadow-sm">
                                                <span className="text-base font-black leading-none">{user.name.substring(0, 2).toUpperCase()}</span>
                                                <span className="text-[8px] opacity-75 mt-0.5">No Photo</span>
                                            </div>
                                        )}
                                        <div className="space-y-0.5 min-w-0 flex-1">
                                            ...
                                            {!profile?.profile_picture_url && (
                                                <Link
                                                    ...
                                                    className="inline-flex items-center space-x-1 text-[10px] text-amber-300 hover:text-amber-200 underline pt-0.5 font-semibold"
                                                >
                                                    <span>Upload Photo for Card</span>
                                                </Link>
                                            )}
                                        </div>
                                    </div>
                                ...
                                {/* Card Footer Security Stripe & 1-Click Download Button */}
                                <div className="space-y-3 pt-1">
                                    ...
                                    <Link
                                        href={route('student.id-card')}
                                        className="w-full py-2.5 px-3 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-black text-xs flex items-center justify-center space-x-2 transition shadow-md group"
                                    >
